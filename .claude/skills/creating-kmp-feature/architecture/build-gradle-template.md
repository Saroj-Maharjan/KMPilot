...
Canonical Gradle setup for `feature/{featurename}/build.gradle.kts`, matching the project's current AGP 9 + Kotlin Multiplatform DSL. Modeled on `feature/sample/build.gradle.kts`.
...
- Working example: `feature/sample/build.gradle.kts`
