...
| iOS-Swift bridge needed | {No / Yes — run /bridge-swift for {Feature}Bridge} |
...
**Group 1: Data Layer** (data-layer) — *network / mixed only*
...
**Group 1b: Platform Layer** (platform) — *Rule 14, tag ≠ `network` only*
...
- *(If `data-layer` is absent, this group also owns module structure + build.gradle.kts)*
