...
**Build status:** PASSING (`./gradlew :feature:sample:assembleAndroidMain`)
**X-components compliance:** PASS — 0 forbidden Material3 component imports.

---

## Token Audit: sample — Success
...
- **Where:** `feature/sample/src/commonMain/kotlin/thisissadeghi/sample/presentation/ui/components/MonthlySummaryCard.kt:32-37`
...
- **Where:** `feature/sample/src/commonMain/kotlin/thisissadeghi/sample/presentation/ui/components/PortfolioSection.kt:103`
...
- **Where:** `feature/sample/src/commonMain/kotlin/thisissadeghi/sample/presentation/ui/components/RecentTransactionsSection.kt:101`
...
## Token Audit: sample — Loading

### CRITICAL — Loading state replaces elaborate design with bare XCircularProgressIndicator
- **Where:** `feature/sample/src/commonMain/kotlin/thisissadeghi/sample/presentation/ui/SampleScreen.kt:125-129`
...
## Token Audit: sample — Failed

**Mismatches: 4 (1 CRITICAL, 3 MINOR).**

### CRITICAL — Missing "Return to Dashboard" secondary action
- **Where:** `feature/sample/src/commonMain/kotlin/thisissadeghi/sample/presentation/ui/SampleScreen.kt:131-173` (`ErrorContent`)
...
- **Fix:** Add a secondary action below the Retry button:
  ...
  ```
  The screen will need a new `onBackToDashboard: () -> Unit` callback wired through `SampleScreen` and `SampleScreenRoot`.

### MINOR — "Something went wrong" headline missing letter-spacing and lineHeight
- **Where:** `feature/sample/src/commonMain/kotlin/thisissadeghi/sample/presentation/ui/SampleScreen.kt:148-155`
...
- **Where:** `feature/sample/src/commonMain/kotlin/thisissadeghi/sample/presentation/ui/SampleScreen.kt:164`
...
- **Where:** `feature/sample/src/commonMain/kotlin/thisissadeghi/sample/presentation/ui/SampleScreen.kt:141-146`
...
## X-Components Compliance Report: sample
...
- `XScaffold` passes `containerColor = MaterialTheme.colorScheme.background` (`SampleScreen.kt:72`).
...
- Retry `XButton` passes `shape = RoundedCornerShape(12.dp)` (`SampleScreen.kt:168`).
